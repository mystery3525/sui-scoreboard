...
function PANEL:UpdatePlayerData()
	...
	self.lblGamemode:SetText( self.Player:GetNWString( "SuiGamemode", "???" ) )
...
function PANEL:Init()
	...
	self.lblGamemode:SetMouseInputEnabled( false )
...
function PANEL:ApplySchemeSettings()
	...
	self.lblGamemode:SetFont( "suiscoreboardplayername"  )
	...
	self.lblGamemode:SetColor( namecolor )
	...
	self.lblGamemode:SetContentAlignment( 5 )
end
...
function PANEL:PerformLayout()
	...
	self.lblGamemode:SetPos( self:GetWide() - COLUMN_SIZE * 8.1, 0 )
